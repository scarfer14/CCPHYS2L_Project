    ...
    <div className="dashboard-wrapper">
      <div className="dashboard-content">
        ...
        <div className="tab fun-facts">
          ...
          <p>Bananas contain potassium, and since potassium decays, that makes them slightly radioactive. Consuming many millions of bananas in a short period of time would reach a lethal dose.</p>
        </div>
