<div className="dashboard-content">
  ...
  <div className="row">
    <div className="tab fun-fact">
      ...
      <p>Neutron stars can spin at 600 rotations per second!</p>
    </div>
  ...
  <div className="row">
    ...
    <div className="tab image">
      ...
      <img src="/assets/icons/galileogalilei.jpg" alt="Sample" />
    </div>
    <div className="tab physics-problem">
      <div className="tab-header1">Problem of The Century</div>
      <p>Why matter  antimatter?</p>
    </div>
  </div>
