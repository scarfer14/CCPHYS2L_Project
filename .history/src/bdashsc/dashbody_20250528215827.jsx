  ...
  return (
    <div className="dashboard-content">
      ...
      <div className="tab multimedia">
        <div className="tab-header">Multimedia</div>
        <iframe
      ...
      <div className="tab folders">
        <div className="tab-header">Folders</div>
      ...
      <div className="tab physics-problem">
        <div className="tab-header">Unsolved Problem</div>
        <p>
      ...
      <div className="tab fun-fact-2">
        <div className="tab-header">Another Fun Fact</div>
