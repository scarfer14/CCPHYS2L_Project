  ...
  return (
    <div className="popup-overlay">
      <div className="popup-content">
        ...
        That is, it made things look three times larger than they did with the naked eye. Through refining the design of the telescope he developed an instrument that could magnify eight times, and eventually thirty times.
