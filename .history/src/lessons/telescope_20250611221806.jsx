  ...
  return (
    <div className="popup-overlay">
      <div className="popup-content">
        ...
        After hearing about the "Danish perspective glass" in 1609, Galileo constructed his own telescope. He subsequently demonstrated the telescope in Venice. His demonstration of the telescope earned him a lifetime lectureship.
