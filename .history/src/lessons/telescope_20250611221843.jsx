  ...
  return (
    <div className="popup-overlay">
      <div className="popup-content">
        ...
        Unlike those other observers, however, Galileo rapidly published his findings.  In some cases, Galileo understood the significance and importance of these observations more readily than his contemporaries. It was this understanding, and foresight to publish, that made Galileo's ideas stand the test of time.</p>
      </div>
    </div>
  );
}